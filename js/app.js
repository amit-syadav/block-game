document.addEventListener("DOMContentLoaded", () => {
  ...
  const myAudioHome = document.getElementById("myAudioHome");
  const myAudioClick = document.getElementById("myAudioClick");
  const myAudioGeneralClick = document.getElementById("myAudioGeneralClick");
  const myAudioLevelComplete = document.getElementById("myAudioLevelComplete");
  const GRID_WIDTH = 10;
